...
class NTFSParser(BaseFilesystemParser):
    FS_NAME = "NTFS"
    MAGIC_SIGNATURES = [b"NTFS    "]
    ...
    def initialize(self) -> bool:
        try:
            ...
            if drive_path.startswith(r"\\.\PhysicalDrive"):
                ...
                volume_path = drive_path
            self.fs_info = {"type": "NTFS", "drive_path": drive_path, "volume_path": volume_path}
            self.initialized = True
            return True
        except Exception as e:
            print(f"NTFS init error: {e}")
            return False
    ...
    def list_directory(self, path: str) -> List[FileEntry]:
        ...
        try:
                ...
                while True:
                    ...
                    if name not in (".", ".."):
                        ...
                        entry = FileEntry(
                            ...
                            attributes={
                                "hidden": bool(find_data.dwFileAttributes & 0x2),
                                "system": bool(find_data.dwFileAttributes & 0x4),
                            }
                        )
            ...
            print(f"Error listing NTFS dir: {e}")
            return []
    ...
    def read_file(self, path: str, size: Optional[int] = None, offset: int = 0) -> bytes:
        ...
        try:
            ...
            print(f"Error reading NTFS file: {e}")
            return b""
    ...
    def write_file(self, path: str, data: bytes, offset: int = 0) -> bool:
        ...
        try:
            ...
            print(f"Error writing NTFS file: {e}")
            return False
