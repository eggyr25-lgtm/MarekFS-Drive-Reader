...
class FAT32Parser(BaseFilesystemParser):
    FS_NAME = "FAT32"
    MAGIC_SIGNATURES = [b"FAT32   "]
    ...
    def detect(self) -> bool:
        try:
            ...
            if len(boot_sector) < 90:
                return False
            return boot_sector[82:90] == b"FAT32   "
        except Exception:
            return False
    ...
    def initialize(self) -> bool:
        try:
            ...
            if drive_path.startswith(r"\\.\PhysicalDrive"):
                ...
                volume_path = drive_path
            self.fs_info = {"type": "FAT32", "drive_path": drive_path}
            self.initialized = True
            return True
        except Exception as e:
            print(f"FAT32 init error: {e}")
            return False
    ...
    def list_directory(self, path: str) -> List[FileEntry]:
        ...
        try:
            ...
            print(f"Error listing FAT32 dir: {e}")
            return []
    ...
    def read_file(self, path: str, size: Optional[int] = None, offset: int = 0) -> bytes:
        ...
        try:
            ...
            print(f"Error reading FAT32 file: {e}")
            return b""
